...
- `train/checkpoints`: Stores all checkpoints generated by `train_model.ipynb`.
- `train/data`: Contains the [KMNIST dataset](https://codh.rois.ac.jp/kmnist/index.html.en).
...
- `server/checkpoints`: Stores trained model checkpoints.
...
- `visualization/imgs`: Sample images for testing.
